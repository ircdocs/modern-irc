...
As the last three examples show, a trailing parameter (a parameter prefixed with `':'`) is another regular parameter. Once the `':'` is stripped, software MUST just treat it as another param.
